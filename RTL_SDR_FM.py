...
class RTL_SDR_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "RTL_SDR_FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTL_SDR_FM")
        ...
        self._tune_range = qtgui.Range(88.7, 100.1, 0.2, 91.5, 200)
        ...
        labels = ['Filtered Real Part', 'Filtered Imaginary Part', 'Signal 3', 'Signal 4', 'Signal 5',
